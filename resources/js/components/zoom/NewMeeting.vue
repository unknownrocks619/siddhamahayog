            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="row clearfix mt-3">
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="form.meeting_name" class="form-control" name="meeting_title" id="meeting_title" require value="" />
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <select v-model="form.meeting_type" name="meeting_type" id="meeting_type" class='form-control' required>
                    ...
                    <div class="row clearfix mt-3">
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <input v-model="form.meeting_lock"  type="radio" name="meeting_lock" id="meeting_lock_yes" value="yes">
                                            <label for="meeting_lock_yes" class='text-success'>
                                                Yes, Lock Meeting
                                            </label>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="radio" v-model="form.meeting_lock" checked name="meeting_lock" id="meeting_lock_no" value="no">
                        ...
                        <div v-if="form.meeting_lock == 'yes'" class="col-lg-6 col-md-6 col-sm-12 m-b-20" id="meeting_lock_settings" >
                            <div class="form-group">
                                <b for="category">
                                    Lock After
                                    <sup class="text-danger">
                                ...
                                <input type="int" v-model="form.meeting_interval" class='form-control' name='meeting_interval' />
                            </div>
                        </div>
                    </div>

                    <div v-if="form.meeting_type == 'scheduled'" class="row clearfix mt-3">
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                <b for="api_token">
                                    Scheduled Date
                                ...
                                <input v-model="form.scheduled_date" class='form-control' type="date" name="scheduled_date" id="meeting_schedule_date">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input v-model="form.scheduled_time" class='form-control' type="time" name="scheduled_time" id="meeting_schedule_time">
                            </div>
                        </div>
                    </div>

                    <div v-if="form.meeting_type == 'reoccuring'" class="row clearfix mt-3">
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                <b>
                                ...
                                <select v-model="form.reoccuring" name='reoccuring' class="form-control">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input v-model="form.reoccuring_meeting_timing" type="time" class="form-control" name="reoccuring_meeting_timing" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix mt-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select v-model="form.timezone" class="form-control  z-index show-tick"  data-live-search="true" name="timezone" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select v-if="zoom_accounts" name="zoom_account"  class='form-control' v-model="form.zoom_account" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <b>Enable Cron Job</b>
                                <select name="cron_job" v-model="form.cron_job" id="cron_job" class="form-control">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select v-model="form.program" v-if="programs" name="program" id="program" class="form-control">
                                    <option v-for="a_program in programs" v-bind:value="a_program.program_id" :key="a_program.program_id">
                                        {{ a_program.program_name }}
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix mt-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select v-if="form.country_lock" class='form-control' name='country_lock'>
...
export default {
  components: { ProgressBar, FormError, ServerResponse },
    ...
    mounted() {
        ...
        let urls = [
            "/api/v1/zoom/account-list",
            "/api/v1/program/list"
        ];
        axios.all(urls.map((url) => axios.get(url))).then(
        (responses) => {
            this.zoom_accounts = responses[0].data.data;
            this.programs = responses[1].data.data
        },
        );
    ...
    methods : {
        validateForm : function () {
            this.serverErrors = [];
            this.errors = [];
            if (this.form.meeting_name == "" ) {
                this.errors.push("You must provide meeting name.");
            }

            if (this.form.meeting_lock == "yes" && this.form.meeting_interval == "") {
                this.errors.push("Please provide meeting lock time relavent to start time.");
            }
            if (this.form.meeting_type == "scheduled" && (this.form.scheduled_date == "" || this.form.scheduled_time == "") ) {
                this.errors.push("Please Provide schduled time and date for scheduled meeting type.");
            }
            

            if (this.form.meeting_type == 'reoccuring' && (this.form.reoccuring == "" || this.form.reoccuring_meeting_timing == "")){
        ...
        submitForm : function (event) {
            ...
            axios.post(this.upload_path,this.form).then(response => {
                this.loading = false;

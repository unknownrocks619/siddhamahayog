...
<div class="col-lg-5 col-md-12 offset-lg-1">
                    <div class="card-plain">
                        ...
                        <div id="error"></div>
                        <form onsubmit="return confirmSubmit()" id="login-form" class="form" method="post" action="{{ route('login') }}">
                            @csrf
    ...
    <script>
        ...
        function invokeCaptcha() {
            grecaptcha.ready(function() {
                grecaptcha.execute('6LcmdQseAAAAANehy0ummHfv31NMLNjAAd3LKmJx', {action: 'contact'}).then(function(token) {

                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <table id="datatable" class="table table-border table-hover">
                            ...
                            <tbody>
                                @foreach ($unpaidlists as $list)
                                <tr>
                                    <td>
                                        {{ $loop->iteration }}
                                    </td>
                                    <td>
                                        {{ $list->student->full_name }}
                                    </td>
                                    <td>
                                        {{ $list->student->phone_number }}
                                    </td>
                                    <td>
                                        {{ $list->student->email }}
                                    </td>
                                    <td>
                                        {{ $list->total_joined }}
                                        <form class="d-inline" onsubmit="return confirm('Are you you want to reset unpaid counter ?')" action="{{ route('admin.program.unpaid.access.reset',$list->getKey()) }}" method="post">
                                            @csrf
                                    ...
                                    <td>
                                        <a class="btn btn-link" data-target="#userDetail" href="{{ route('admin.program.unpaid.access.list-view',[$list->program_id,$list->member_id]) }}" data-toggle="modal">View Detail</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>

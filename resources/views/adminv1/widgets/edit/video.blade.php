                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            @include("adminv1.widgets.create.video.sample")
                                ...
                                <div class="row mb-3 pb-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $widget->widget_name }}" type="text" name="widget_name"
                                                   id="widget_name" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="layout" id="layout" class="form-control">
                                                <option value="background"
                                                        @if(old('layout',$widget->layouts->layout)=="background" ) selected @endif>
                                                    Background Video
                                                </option>
                                                <option value="checkmark_video"
                                                        @if(old('layout' ,$widget->layouts->layout)=="checkmark_video" ) selected @endif>
                                                    Video With Checkmark
                                                </option>
                                                <option value="single_video"
                                                        @if(old('layout' ,$widget->layouts->layout)=="single_video" ) selected @endif>
                                                    Single Video
                                                </option>
                                                <option value="two_column"
                                                        @if(old('layout' ,$widget->layouts->layout)=="two_column" ) selected @endif>
                                                    Two Column Per Row
                                                </option>
                                                <option value="full_width_video"
                                                        @if(old('layout' ,$widget->layouts->layout)=="full_width_video" ) selected @endif>
                                                    Full Width Video
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-group">
                                            ...
                                            <select name="featured_video" id="featured_video" class="form-control">
                                                <option value="yes"
                                                        @if(old('featured', (isset($widget->settings->featured) && $widget->settings->featured == true) ? "yes" : "no") =="yes" ) selected @endif>
                                                    Yes
                                                </option>
                                                <option value="no" @if(old('featured') !="yes" ) selected @endif>No
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row @if($loop->iteration > 1) mt-4 bg-light py-4 @endif">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="video_link[]" value="{{ $field->video->link }}"
                                                       placeholder="https://youtube.com/watch/?v=sqiu23dg or https://vimeo.com/watch/34234343"
                                                       class="form-control"/>
                                            </div>
                                        </div>

                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            @include("adminv1.widgets.create.image.sample")
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="form-group">
                                            ...
                                            <select name="layout" id="layout" class="form-control">
                                                ...
                                                <option value="right_align_image"
                                                        @if(old('layout', $widget->layouts->layout)=="foldable" ) selected @endif>
                                                    Right Align Image
                                                </option>
                                                <option value="left_align_image"
                                                        @if(old('layout', $widget->layouts->layout)=="foldable" ) selected @endif>
                                                    Left Align Image
                                                </option>
                                                <option value="alternate"
                                                        @if(old('layout', $widget->layouts->layout)=="foldable" ) selected @endif>
                                                    Alternate Align Image
                                                </option>
                                                <option value="single"
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="background_color" class="form-control"
                                                   ...
                                                   value="{{ old('background_color', ($widget->settings && isset($widget->settings->theme_color)) ? $widget->settings->theme_color : null ) }}"/>
                                        </div>
                                    </div>
                                </div>

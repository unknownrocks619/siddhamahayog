...
<section class="content">
    <div class="container-fluid">
        ...
        <form enctype="multipart/form-data" action="{{ route('admin.notices.notice.store') }}" method="post">
            @csrf
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                <li class="dropdown"> <a href="{{ route('admin.notices.notice.index') }}" class="btn btn-danger btn-sm">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="active" id="notice_type" class="form-control">

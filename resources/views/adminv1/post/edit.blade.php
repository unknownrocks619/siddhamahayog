                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            ...
                                            <select name="post_type" id="post_type" class="form-control">
                                                ...
                                                <option value="auth_user" @if(old('post_type',$post->post_type) == "auth_user") selected @endif>Autheticated User</option>
                                                <option value="staff" @if(old('post_type',$post->post_type) == "staff") selected @endif>Staffs</option>
                                            </select>

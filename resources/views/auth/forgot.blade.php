                	...
                	<div class="loginbox">
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
                                ...
                                <x-alert></x-alert>
								<!-- Form -->
								<form method="post" action="{{ route('public_send_password_link') }}">
                                    @csrf
									<div class="form-group">
                                        @error('username')
                                            <span class='text-danger'> {{ $message }} </span>
                                        @enderror
                                        <label class='control-label'>Provide your Email or Login ID</label>
										<input class="form-control" name="username" required type="text" placeholder="Login ID or Email Address">
                                        <div class='text-right text-info'>
                                            <a href="{{ route('public_user_login') }}">I know my password</a>
                                        </div>

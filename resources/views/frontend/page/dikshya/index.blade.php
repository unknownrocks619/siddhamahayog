...
<head>
    ...
    <title>Himalayan Siddhababa Spiritual Academy::Diskshya Program::Registratioon Form</title>
...
<body>
    <div class="container d-none d-md-block">
        <div class="row py-2">
            <div class="col-md-3 d-flex justify-content-center align-items-center">
                <img src="https://psmyoga.ca/wp-content/uploads/2021/02/LogoT-e1621667004612-150x150.png"
                    class="img-responsive" style="height:95px; width:95px;" />
            ...
            <div class="col-md-9 d-flex justify-content-end align-items-center">
                @guest
                    <div class="col-md-8 d-flex justify-content-end">
                        <button type="button" class="btn border-none btn-pink-moon fs-4 clickable"
                ...
                @else
                    <div class="col-md-8 d-flex justify-content-end">
                        <button type="button" class="btn border-none btn-pink-moon w-50 fs-4 clickable"
                            data-href="{{ route('dashboard') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24"
                                style="fill: rgba(133, 95, 95, 1);transform: ;msFilter:;">
                                <path
    ...
    <nav id="navbar_main" class="d-block d-sm-none mobile-offcanvas navbar navbar-expand-lg navbar-light p-0 w-100 nav">
            ...
            <div class="col d-flex justify-content-end align-items-center">
                <button class="navbar-toggler me-4" type="button" data-bs-toggle="collapse"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <g id="surface132455688">
                            <path
                                style=" stroke:none;fill-rule:nonzero;fill:rgb(100%,99.607843%,99.607843%);fill-opacity:1;"
                                d="M 0 7.5 L 0 12.5 L 50 12.5 L 50 7.5 Z M 0 22.5 L 0 27.5 L 50 27.5 L 50 22.5 Z M 0 37.5 L 0 42.5 L 50 42.5 L 50 37.5 Z M 0 37.5 " />
                        </g>
                    </svg>
                </button>
                ...
                <button class="navbar-toggler close-bar d-none pe-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"
                        style="fill: rgba(236, 230, 230, 1);transform: ;msFilter:;">
                        <path
        ...
        <div id="navbarSupportedContent" class="navbar-collapse collapse">
            <ul class="navbar-nav align-items-center" style="flex-wrap: wrap;margin-left:10px;">
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link active clickable" data-href="{{ route('dashboard') }}"
                            href="#">Dashboard</a>
                    </li>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="https://siddhamahayog.org" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        कार्यक्रमहरू
                    </a>
                    <ul class="dropdown-menu theme-text py-2" style="background-color: var(--nav-background);">
                        <li><a class="dropdown-item py-2" style="color:var(--nav-link)"
                                href="https://siddhamahayog.org">जगद्गुरू श्रीरामानन्दाचार्य सेवा पीठ​</a></li>
                        <li><a class="dropdown-item" style="color:var(--nav-link)"
                                href="https://siddhamahayog.org">वेदान्त दर्शन</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    ...
                    <form action="{{ route('logout') }}" method="post">
                        ...
                        <button type="submit" class="btn btn-link hover-text text-decoration-none">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                                viewBox="0 0 24 24" style="fill: rgba(133, 95, 95, 1);transform: ;msFilter:;">
                                <path d="m2 12 5 4v-3h9v-2H7V8z"></path>
                                <path
                                    d="M13.001 2.999a8.938 8.938 0 0 0-6.364 2.637L8.051 7.05c1.322-1.322 3.08-2.051 4.95-2.051s3.628.729 4.95 2.051 2.051 3.08 2.051 4.95-.729 3.628-2.051 4.95-3.08 2.051-4.95 2.051-3.628-.729-4.95-2.051l-1.414 1.414c1.699 1.7 3.959 2.637 6.364 2.637s4.665-.937 6.364-2.637c1.7-1.699 2.637-3.959 2.637-6.364s-.937-4.665-2.637-6.364a8.938 8.938 0 0 0-6.364-2.637z">
                                </path>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3 ps-0 ms-0">
                <img class="img-fluid h-100 d-none d-md-block"
                    src="https://psmyoga.ca/wp-content/uploads/2021/05/gurudevWBG-580x1024.jpg" />
            </div>
            <div class="col-md-9">
                <div class="alert alert-danger d-none" id="errorMessage"></div>
                <div class="row mt-3">
                    <div class="col-md-12 d-flex justify-content-center">
                        <h2 class="theme-text fw-bold border-bottom pb-3">हिमालयन सिद्घमहायोग - दिक्षा फारम</h2>
                    </div>
                    <div class="col-md-12">
                        <x-alert></x-alert>
                    </div>
                ...
                <div class="row mt-4">
                    ...
                    @if (user())
                        @include('frontend.page.dikshya.auth.check-record')
                    @else
                        <form action="{{ route('dikshya.store', 'first') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-7 border-end border-theme">
                                    @include('frontend.page.dikshya.parts.basic')
                                </div>
                                <div class="col-md-5 ps-2">
                                    @include('frontend.page.dikshya.parts.emergency-contact-information')
                                    @include('frontend.page.dikshya.parts.reference')
                                    @include('frontend.page.dikshya.parts.login')
                                </div>
                            </div>
                        </form>
                    @endif
    ...
    <script>
        ...
        $("input#terms_and_condition").change(function() {
            if ($(this).val() == 1) {
                $("button.enroll-sadhana").prop('disabled', false).removeClass('disabled btn btn-outline-primary')

...
<head>
    ...
    <link
      rel=" stylesheet"
        type="text/css" href="{{ asset('vassets/login/vendor/css-hamburgers/hamburgers.min.css') }}" />
    <link rel="stylesheet" type="text/css"
...
<body>
    <div class="limiter">
        <div class="container-login100"
            style="background-image: url({{ asset('assets/login/images/login-background.png') }})">
            <div class="wrap-login100 p-l-110 p-r-110 p-b-33">
                ...
                <form id="loginForm" class="validate-form" action="{{ route('login') }}" method="post">
                    ...
                    <div class="wrap-input100 validate-input" autofocus="true" data-validate="Email is required"
                        required="true">
                        <input class="input100 " type="text" name="email_user" />
                ...
                <div class="d-flex justify-content-center pt-4 mt-4 text-secondary p-b-20"> Don't Have account ?
                </div>
                <div class="w-full text-center">
                    <a href="{{ route('register') }}" class=" btn btn-danger w-100 text-white py-3"> Sign up now
                    </a>
                </div>
                <div class="row mt-4">
                    <div class="col-md-12">
                        <form class="w-100" action="{{ route('social_login_redirect', ['facebook']) }}"
                            id="facebookForm" method="post">
                            @csrf
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('social_login_redirect_google') }}" id="googleForm" method="post">
                            ...
                            <button type="submit" class="w-100 btn btn-outline-danger py-2 px-5 m-b-20">
                                <img src="{{ asset('assets/login/images/icons/icon-google.png') }}"
                                    alt="GOOGLE" />

...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <x-alert></x-alert>
                <form id="stripePaymentForm" enctype="multipart/form-data"
                    action="{{ route('user.account.programs.payment.stripe.process', [$program->id]) }}" method="post">
                    @csrf
                    <div class="card mb-4">
                        <div class="row d-flex justify-content-between mt-2">
                            <div class="col-md-8">
                                <h5 class="card-header mt-0 pt-0">You are paying using<span class="fs-4 text-success">`Visa
                                        / Debit Card (Internation)`</span> </h5>
                            </div>
                            <div class="col-md-4">
                                <button class="btn btn-sm btn-danger clickable"
                                    data-href="{{ route('user.account.programs.courses.fee.list', $program->id) }}">
                        ...
                        <div class="card-body">
                            <p class="text-info">
                                Please Note: We do not store any card or personal information. All payments are processed by
                                stripe.
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="amount" type="text" value="199" readonly required
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="card_holder_name" id="card-holder-name"
                                            class="form-control card_holder_name" required />
                                    </div>
                                </div>
                            </div>

...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset ('themes/app/assets/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset ('themes/app/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    <!-- <link rel="stylesheet" href="../assets/css/demo.css" /> -->

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ asset ('themes/app/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />

                ...
                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    ...
                    <div class="user-progress">
                        ...
                        $scholarship = \App\Models\Scholarship::where('program_id', $program->program_id ?? 0)
                            ...
                            ->first();
                        ?>
                        <?php if ($program->live && $program->live->live && $program->program && $program->program->program_type == "paid" && $scholarship) : ?>
                        ...
                        <?php
                        elseif ($program->live && $program->live->live && $program->program && $program->program->program_type == "paid" && !$program->program->student_admission_fee) :

            ...
            <div class="card-body text-center">
                ...
                <div class="row mt-3">
                    <div class="col-md-12 text-center">
                        ...
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/{{ $notice->settings->id }}" title="{{ $notice->title }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            ...
            <div class="card-header d-flex align-items-start align-items-sm-center gap-4 justify-content-between">
                ...
                <div class="dropdown">
                    <button data-href="{{ route('user.account.programs.program.index') }}"
                        class="clickable btn btn-danger" type="button" id="orederStatistics">
            ...
            <div class="card-body">
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                    <div class="button-wrapper">
                        <p class="text-muted mb-0">Offline Videos for {{ $program->program_name }} will be available
                            here.</p>
                    </div>
                                ...
                                @forelse ($program->videoCourses as $courses)
                                    <div class="card accordion-item">
                                        <h2 class="accordion-header">
                                            <button type="button"
                                                class="accordion-button border-bottom bg-secondary text-white"
                                                data-bs-toggle="collapse" data-bs-target="#{{ $courses->slug }}"
                                        ...
                                        <div id="{{ $courses->slug }}" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body"
                                                ...
                                                @forelse ($courses->lession as $lession)
                                                    @include(
                                                        'frontend.user.program.videos.partials.lister',
                                                        compact('lession', 'courses'))
                                                @empty
                                                    <div class="alert alert-danger mt-3">
                                                        Lessions for {{ $courses->course_name }} is currently
                                                        unavailable.
                        ...
                        <div style="position:relative" class="w-100 h-100">
                            <div class="progress mt-5" style="height:25px;position:absolute;z-index:9">
                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-dark"
                                    role="progressbar" style="width: 100%;height:25px" aria-valuenow="100"
                                    aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div id="videoContent">
                                @if ($program->last_video_history)
                                    @include('frontend.user.program.videos.modal.history', [
                                        'watchHistory' => $program->last_video_history,
                                    ])
                                @else
                        ...
                        <div class="row">
                            <div class="accordion mt-3" id="accordionExample">
                                    ...
                                    <div class="card accordion-item">
                                        ...
                                        <div id="{{ $courses->slug }}" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                @forelse ($courses->lession as $lession)
                                                    <li
                                                        class="list-group-item border-bottom-1 border-start-0 border-end-0 border-top-0 rounded-0">
                                                        <button class="btn btn-link ps-0 watchLession"
                                                            data-href="{{ route('user.account.programs.videos.show', [$program->id, $courses->id, $lession->id]) }}"
                                                            type="button"><i class='bx bxs-movie-play me-2'></i>
                                                            {{ $lession->lession_name }}</button>
                                                    </li>
                                                @empty
                                                    <div class="alert alert-danger mt-3">
                                                        Lessions for {{ $courses->course_name }} is currently
                                ...
                                @empty
                                    <div class="card accordion-item active">
                                        <h2 class="accordion-header bg-primary">
                                            <button type="button" class="accordion-button bg-primary"
                                                data-bs-toggle="collapse" data-bs-target="#accordionTwo"
                                                aria-expanded="true" aria-controls="accordionTwo">
                                                {{ $program->program_name }}
                                            </button>

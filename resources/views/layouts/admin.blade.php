...
<head>
  ...
  <!-- BEGIN: Body-->
  <body class="vertical-layout vertical-menu-modern dark-layout 2-column  navbar-sticky footer-static bg-full-screen-image @if( ! Auth::check()) blank-page @endif" data-open="click" data-menu="vertical-menu-modern" data-col="2-column" data-layout="dark-layout" style='background-repeat: repeat'>
    <!-- BEGIN: Content-->
    @if( auth()->check() &&  isAdmin())
      @include('admin.inc.sidebar_navigation')
    @endif

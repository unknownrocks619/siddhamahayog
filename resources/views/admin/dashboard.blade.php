...
@section('main')
    ...
    <div class="row">
        @if (in_array(adminUser()->role(), App\Models\Program::GO_LIVE_ACCESS))
            @php
                $lives = App\Models\Live::where('live', true)
                    ->with(['program', 'sections', 'zoomAccount'])
                    ->get();
            @endphp
            <!-- Website Analytics -->
                                ...
                                <tbody>
                                    @forelse ($lives as $live)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('admin.program.admin_program_detail', ['program' => $live->program->getKey()]) }}">
                                            ...
                                            <td>
                                                @if ($live->section_id)
                                                    <span
                                                        class="label label-bg-success">{{ $live->programSection->section_name }}</span>
                                                @else
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <button data-title="Confirm End Live Meeting"
                                                        ...
                                                        type="button"
                                                        class="btn btn-sm btn-danger data-confirm">End</button>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="search" placeholder="Booking ID" name="bookingID" id="quickCheckIn"
                        ...
                        <div class="d-none row " id="errorDisplay">
                            <div
                                class="col-md-12 bg-danger fs-2 text-center text-white d-flex align-items-center justify-content-center">

                            </div>
                        </div>
                        <div class="row mt-4 d-none" id="booking-status">
                            <div
                                class="col-md-12 h-75 bg-success text-center d-flex align-items-center justify-content-center">
                                <div>
                                ...
                                <ul class="p-0 m-0 d-flex">
                                    <li class="d-flex gap-3 align-items-center mb-lg-3 pt-2 pb-1">
                                        ...
                                        <div>
                                            ...
                                            <small
                                                class="text-muted">{{ \App\Models\SupportTicket::totalNewTicket() }}</small>
                                        </div>
                                    </li>
                                    <li class="d-flex mx-3 gap-3 align-items-center mb-lg-3 pb-1">
                                        ...
                                        <div>
                                            ...
                                            <small
                                                class="text-muted">{{ \App\Models\SupportTicket::totalOpenTicket() }}</small>
                                        </div>
                                    </li>
                                    <li class="d-flex mx-3 gap-3 align-items-center mb-lg-3 pb-1">
                                        <div class="badge rounded bg-label-info p-1"><i
                                        ...
                                        <div>
                                            ...
                                            <small
                                                class="text-muted">{{ \App\Models\SupportTicket::totalClosedTicket() }}</small>
                                        </div>
                                    </li>
                                </ul>
                            </div>

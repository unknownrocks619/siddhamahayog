@php
    ...
    if (request()->availableDate) {
        $availableDate = request()->availableDate;
        $volunteerDate = \App\Models\ProgramVolunteerAvailableDates::find(request()->availableDate);
    }

@endphp
<form method="post" class="ajax-form" action="{{route('admin.program.volunteer.admin_volunteer_update_status',['program' => $program,'volunteer' => $volunteer ])}}">

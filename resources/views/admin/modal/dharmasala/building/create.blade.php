<form method="post" class="ajax-append ajax-form" action="{{route('admin.dharmasala.building.create')}}">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel1">Dharamsala Building</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="total_floors" id="floors" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="building_location" id="building_location" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="building_color">Building Color</label>
                    <input type="color" name="building_color" id="building_color" class="form-control" />
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control">
                        ...
                        <option value="online">Inactive</option>
                    </select>
                </div>
            </div>
        </div>

        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input data-action="{{route('admin.members.admin_add_assign_member_to_program',request()->program)}}" type="text" placeholder="Search Member by Email or phone" name="member" id="member" class="form-control" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">

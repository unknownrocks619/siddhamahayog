...
<section class="content">
    <div class="container-fluid">
        ...
        <x-alert></x-alert>
        <form action="{{ route('admin.website.menus.admin_update_menu',$menu->id) }}" enctype="multipart/form-data" method="post">
            @method("PUT")
            @csrf
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                <strong>Update </strong> {{ $menu->menu_name }}
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="slug" value='{{ old("slug",$menu->slug) }}' id="slug" placeholder="[Auto-Generate]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="menu_type" id="menu_type" class="form-control">
                                                    <option value="home" @if(old('menu_type',$menu->menu_type) == "home") selected @endif>Home page</option>
                                                    ...
                                                    <option value="events" @if(old('menu_type',$menu->menu_type) == "events") selected @endif>Events List</option>
                                                    <option value="program" @if(old('menu_type',$menu->menu_type)=="program" ) selected @endif>Program</option>
                                                    <option value="products" @if(old('menu_type',$menu->menu_type) == "products") selected @endif>Products List</option>
                                                    <option value="service" @if(old('menu_type',$menu->menu_type) == "service") selected @endif>Service</option>
                                                    ...
                                                    <option value="live" @if(old('menu_type',$menu->menu_type) == "live") selected @endif>Live Boarcast</option>
                                                    <option value="volunteer" @if(old('menu_type',$menu->menu_type) == "volunteer") selected @endif>Volunteer</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="active_status" id="active_status" class="form-control">
                                                    <option value="1" @if(old('active',$menu->active)) selected @endif>Yes</option>
                                                    <option value="0" @if( ! old('active',$menu->active)) selected @endif>No</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($menu->menu_featured_image)
                                            <img src='{{ $menu->menu_featured_image }}' />
                                            @else
                                            Not Available
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="form-group">
                                                ...
                                                <select name="menu_position" id="menu_poistion" class="form-control">
                                                    <option value="top" @if(old('menu_position',$menu->menu_position) == "top") selected @endif>Top Menu</option>
                                                    <option value="main_menu" @if(old('menu_position',$menu->menu_position) == "main_menu") selected @endif>Main Menu</option>
                                                    <option value="footer" @if(old('menu_position',$menu->menu_position) == "footer") selected @endif>Footer Menu</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="form-group">
                                                ...
                                                <select name="parent_menu" id="parent_menu" class="form-control">
                                                    ...
                                                    <option value="{{$list_menu->id}}" @if(old('parent_menu',$menu->parent_menu) == $list_menu->id) selected @endif>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="meta_description" id="meta_description">{{ old('meta_description',$menu->meta_description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>

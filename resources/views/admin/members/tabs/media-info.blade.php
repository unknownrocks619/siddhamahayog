<button class="btn btn-danger btn-icon my-2">
...
<div class="card mb-4">
    <div class="card-header">
        ...
        <div id="uploadMedia" class="collapse">
            <form action="{{route('admin.members.media.upload',['member' => $member])}}" method="post" class="ajax-component-form ajax-append">
                <div class="row">
                    <div class="col-md-6">

                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('admin.program.courses.admin_program_course_list_lession_modal',[$course->id]) }}" data-target="#addNewLession" data-toggle="modal" class='text-muted'>View Videos</a>
                                    <br />

...
@section('main')
    ...
    <div class="card">
        <form class="ajax-form" action="{{route('admin.program.admin_program_edit',['program' => $program])}}" method="post">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" value="{{$program->admission_fee}}" name="admission_fee" id="admission_fee" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="{{$program->monthly_fee}}" name="monthly_fee" id="monthly_fee" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row my-2">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="batch" id="batch-select" class="form-control ajax-select-2"  data-action="{{route('admin.select2.batch-list')}}">
                                @if($program->defaultBatch)
                                    <option value="{{$program->defaultBatch->getKey()}}" selected>{{$program->defaultBatch->batch_name}}</option>
                                @endif
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="section" id="section-select" class="form-control ajax-select-2" data-action="{{route('admin.select2.program-section-list',['program' => $program])}}">
                                @if($program->active_sections)
                                    <option value="{{$program->active_sections->getKey()}}">{{ $program->active_sections->section_name }}</option>
                                @endif
                            </select>
                        </div>
                    </div>

<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('admin.program.batches.admin_batch_student_change',[$student->program_id,$student->student->id]) }}" data-target="#edit_create_section" data-toggle="modal">Change Batch</a>
            </td>
        ...
        <tr>
            <td colspan="6" class="text-center">
                {{ $batch->batch_name }} doesn't have any student.
            </td>
        </tr>
        @endforelse
    </tbody>

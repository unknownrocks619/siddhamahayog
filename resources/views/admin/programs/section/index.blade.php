...
@section('main')
                                            ...
                                            <div class="col-md-12 d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            data-confirm="You are about to delete the section from this program. Members from this section will be transferred to default section. Do you wish to continue."
                                                    ...
                                                    <button
                                                            type="button"
                                                            data-method="get"
                                                            data-action="{{route('admin.program.sections.admin_update_default_section',['program'=>$program,'section' => $section])}}"
    ...
    <x-modal modal="createNewSection">
        @include('admin.modal.programs.section.new',['program' => $program,'callback' => 'reload'])
    </x-modal>
@endsection

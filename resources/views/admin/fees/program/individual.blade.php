                                ...
                                @foreach ($transaction->transactions as $all_detail_transaction)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                if ($all_detail_transaction->file) {
                                                        $file_object = json_decode($all_detail_transaction->file);
                                        ...
                                        <td>
                                            @php
                                                $action = "";
                                                    $action .= "<form style='display:inline' method='PUT' class='transaction_action_form' action='".route('fee.api_update_fee_detail',[$all_detail_transaction->id])."'>";
                                                    ...
                                                    $action .= "<form style='display:inline' method='DELETE' action='".route('fee.api_delete_fee',$all_detail_transaction->id)."' class='transaction_delete_form'>";
                                                        $action .= "<input type='hidden' name='update_type' value='status' />";

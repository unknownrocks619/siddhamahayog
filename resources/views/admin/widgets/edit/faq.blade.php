            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        @include("admin.widgets.create.faq.sample")
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <select name="layout" id="layout" class="form-control">
                                            <option value="full_faq" @if(old('layout', $widget->layouts->layout)=="full_faq" ) selected @endif>Full Column FAQ</option>
                                            <option value="with_image" @if(old('layout', $widget->layouts->layout)=="with_image" ) selected @endif>Side Image Faq</option>
                                        </select>
                                    </div>
                                </div>
                            </div>

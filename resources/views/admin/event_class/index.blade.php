            ...
            <table class="table table-striped table-bordered complex-headers">
              <thead>
                <tr>
                  ...
                  <th class='text-center bg-dark text-white'>Zonal</th>
                  ...
                  @foreach ($all_class as $event )
                      <tr>
                        ...
                        <td>
                            ...
                            <br />
                            <!-- <a href="{{-- route('events.admin_view_active_attendance',[$event->id]) --}}">
                              View Attendance</a> -->
                        </td>
                        <td>
                          @if ( ! $event->is_active)
                            <a href="{{ route('events.admin_view_zone_settings',$event->id) }}" class='btn btn-sm btn-warning  text-white'>Zonal Live</a>
                          @endif
                        </td>
                        <td>
                        @if($event->is_active) 

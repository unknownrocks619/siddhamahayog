@if (is_null($program->request_type) || adminUser()->role()->isSuperAdmin())
...
@else
    <button type='button' disabled data-confirm='You are about to delete selected transaction. This action cannot be undone. Do you wish to continue your action ?' class='btn btn-warning btn-icon'><i class='fas fa-trash'></i></button>

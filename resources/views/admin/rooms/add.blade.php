    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
                    ...
                    <form method="POST" action="{{ route('rooms.save-room') }}" class="form-validate">
                        @csrf
                            ...
                            <div class="col-md-12 col-sm-4">
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <textarea name='room_description' class='form-control'>{{ old('room_description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="room_type" class="form-control">
                                        <option value="hall" @if(old('room_type') == "hall") selected @endif>Hall</option>
                                        <option value="deluxe" @if(old('room_type') == "deluxe") selected @endif>Deluxe</option>
                                        <option value="single" @if(old('room_type') == "single") selected @endif>Single</option>
                                        <option value="other" @if(old('room_type') == "other") selected @endif>Other</option>
                                    </select>
                                </div>  
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class='form-control' name="room_location" value="{{ old('room_location') }}" />
                                </div>  
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="room_category" class="form-control">
                                        <option value="VIP"  @if(old('room_category') == "hall") selected @endif>VIP</option>
                                        <option value="Regular"  @if(old('room_category') == "Regular") selected @endif>Regular</option>
                                        <option value="Standard"  @if(old('room_category') == "Standard") selected @endif>Standard</option>
                                        <option value="Other"  @if(old('room_category') == "Other") selected @endif>Other</option>
                                    </select>
                                </div>  
                            </div>
                        </div>

...
function websdkready() {
  ...
  const API_KEY = "pUBhiJDjTRWhoWAenjkmLQ";
  const API_SECRET = "ZbQiQsEZxtAwd78PcpAX1bZH5SQp1FlVS7Ut";
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        apiKey: "pUBhiJDjTRWhoWAenjkmLQ",
        apiSecret: "ZbQiQsEZxtAwd78PcpAX1bZH5SQp1FlVS7Ut",
        role: meetingConfig.role,
        success: function (res) {
          console.log(res.result);
          meetingConfig.signature = res.result;
          meetingConfig.apiKey = "pUBhiJDjTRWhoWAenjkmLQ";
          var joinUrl = "/zoom-sdk/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);

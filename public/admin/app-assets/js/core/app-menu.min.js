!(function (s, o, r) {
    ...
    (r.app.menu = {
        ...
        manualScroller: {
            ...
            update: function () {
                if (this.obj) {
                    if (!0 === r(".main-menu").data("scroll-to-active")) {
                        var e, n, a;
                        if (((e = o.querySelector(".main-menu-content li.active")), l.hasClass("menu-collapsed")))
                            r(".main-menu-content li.sidebar-group-active").length && (e = o.querySelector(".main-menu-content li.sidebar-group-active"));
            ...
            updateHeight: function () {
                ("vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") && "vertical-overlay-menu" != l.data("menu")) ||
                    !r(".main-menu").hasClass("menu-fixed") ||
                    (r(".main-menu-content").css("height", r(s).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight()), this.update());
            },
        },
        init: function (e) {
        ...
        drillDownMenu: function (e) {
            r(".drilldown-menu").length && (("sm" != e && "xs" != e) || "true" == r("#navbar-mobile").attr("aria-expanded")) && r(".drilldown-menu").slidingMenu({ backLabel: !0 });
        },
        change: function (e, n) {
            ...
            ("vertical-menu" !== t && "vertical-menu-modern" !== t) || this.toOverlayMenu(a.name, t),
                l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(a.name), r(".menu-toggle").removeClass("is-active")),
                "horizontal-menu" != t && this.drillDownMenu(a.name),
                "xl" == a.name &&
            ...
            l.addClass("changing-menu"),
                ...
                l.hasClass("vertical-layout") &&
                    (l.hasClass("menu-open") || l.hasClass("menu-expanded")
                        ? (r(".menu-toggle").addClass("is-active"), "vertical-menu" === l.data("menu") && r(".main-menu-header") && r(".main-menu-header").show())
                        : (r(".menu-toggle").removeClass("is-active"), "vertical-menu" === l.data("menu") && r(".main-menu-header") && r(".main-menu-header").hide())),
                setTimeout(function () {
        ...
        open: function () {
            this.transit(
                ...
                function () {
                    !r(".main-menu").hasClass("menu-native-scroll") &&
                        r(".main-menu").hasClass("menu-fixed") &&
                        (this.manualScroller.enable(), r(".main-menu-content").css("height", r(s).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight())),
        ...
        expand: function () {
            !1 === this.expanded &&
                ("vertical-menu-modern" == l.data("menu") && r(".modern-nav-toggle").find(".toggle-icon").removeClass("bx bx-circle").addClass("bx bx-disc"),
                this.transit(
                    function () {
                    ...
                    function () {
                        r(".main-menu").hasClass("menu-native-scroll") || "horizontal-menu" == l.data("menu") ? this.manualScroller.disable() : r(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
                            ("vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu")) ||
                                !r(".main-menu").hasClass("menu-fixed") ||
                                r(".main-menu-content").css("height", r(s).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight());
                    }
                ));
        },
        collapse: function (e) {
            !1 === this.collapsed &&
                ("vertical-menu-modern" == l.data("menu") && r(".modern-nav-toggle").find(".toggle-icon").removeClass("bx bx-disc").addClass("bx bx-circle"),
                this.transit(
                    function () {
                    ...
                    function () {
                        "horizontal-menu" == l.data("menu") && l.hasClass("vertical-overlay-menu") && r(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
                            ("vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu")) || !r(".main-menu").hasClass("menu-fixed") || r(".main-menu-content").css("height", r(s).height() - r(".header-navbar").height()),
        ...
        toOverlayMenu: function (e, n) {
            ...
            "vertical-menu-modern" == n
                ? "lg" == e || "md" == e || "sm" == e || "xs" == e
                    ? l.hasClass(a) && l.removeClass(a).addClass("vertical-overlay-menu")
                    : l.hasClass("vertical-overlay-menu") && l.removeClass("vertical-overlay-menu").addClass(a)
                : "sm" == e || "xs" == e
                ? l.hasClass(a) && l.removeClass(a).addClass("vertical-overlay-menu")
                : l.hasClass("vertical-overlay-menu") && l.removeClass("vertical-overlay-menu").addClass(a);
        },
        changeMenu: function (e) {
            r('div[data-menu="menu-wrapper"]').html(""),
                r('div[data-menu="menu-wrapper"]').html(m),
                r(".menu-livicon").removeLiviconEvo(),
                r.each(r(".menu-livicon"), function (e) {
                    var n = r(this),
                        a = n.data("icon"),
                    ...
                    n.addLiviconEvo({
                        ...
                        afterAdd: function () {
                            e === r(".main-menu-content .menu-livicon").length - 1 &&
                                r(".main-menu-content .nav-item a").on("mouseenter", function () {
            ...
            "xl" === e
                ...
                : (l.removeClass(l.data("menu")).addClass("vertical-layout vertical-overlay-menu fixed-navbar"),
                  ...
                  n.removeClass().addClass("main-menu menu-fixed menu-shadow"),
                  "dark-layout" === l.data("layout") || "semi-dark-layout" === l.data("layout") ? n.addClass("menu-dark") : n.addClass("menu-light"),
                  a.removeClass().addClass("navigation navigation-main"),
                  i.removeClass("dropdown").addClass("has-sub"),
                  i.find("a").removeClass("dropdown-toggle nav-link"),
                  i.children("ul").find("a").removeClass("dropdown-item"),
                  i.find("ul").removeClass("dropdown-menu"),
                ...
                r(".nav-item.active .menu-livicon").length && t(r(".nav-item.active .menu-livicon")),
                r(".main-menu-content li.sidebar-group-active .menu-livicon").length && t(r(".main-menu-content li.sidebar-group-active .menu-livicon"));
        },
        toggle: function () {
            ...
            switch (e.name) {
                ...
                case "lg":
                    !0 === n
                        ? "vertical-overlay-menu" == i || "vertical-menu-modern" == i || "horizontal-menu" == i
                            ? this.hide()
                            : this.collapse()
                        : "vertical-overlay-menu" == i || "vertical-menu-modern" == i || "horizontal-menu" == i
                        ? this.open()
        ...
        (r.app.nav = {
                ...
                r(".navigation-main")
                    .on("mouseenter.app.menu", "li", function () {
                        ...
                        if ((r(".hover", ".navigation-main").removeClass("hover"), l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu"))) {
                            ...
                            if (
                                (e.hasClass("has-sub") || ((n = e.find("span.menu-title").text()), (a = e.children("a").attr("href")), "" !== n && ((o = r("<a>")).attr("href", a), o.attr("title", n), o.text(n), o.addClass("menu-title"))),
                                (i = e.css("border-top") ? e.position().top + parseInt(e.css("border-top"), 10) : e.position().top),
                                "vertical-compact-menu" !== l.data("menu") && o.appendTo(".main-menu-content").css({ position: "fixed", top: i }),
                    ...
                    .on("click.app.menu", "li", function (e) {
                        var n = r(this);
                        n.is(".disabled") || (l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu"))
                            ? e.preventDefault()
                            : n.has("ul")
                            ? n.is(".open")
                    ...
                    r(".main-menu-content").on("mouseleave", function () {
                        l.hasClass("menu-collapsed") && (r(".main-menu-content").children("span.menu-title").remove(), r(".main-menu-content").children("a.menu-title").remove(), r(".main-menu-content").children("ul.menu-content").remove()),
            ...
            adjustSubmenu: function (e) {
                var n,
                    ...
                    o,
                    t,
                    s = e.children("ul:first"),
                    l = s.clone(!0);
                r(".main-menu-header").height(),
                    (n = e.position().top),
                    (i = d.height() - r(".header-navbar").height()),
                    (t = 0),
                    s.height(),
                    0 < parseInt(e.css("border-top"), 10) && (t = parseInt(e.css("border-top"), 10)),
                    (o = i - n - e.height() - 30),
                    r(".main-menu").hasClass("menu-dark"),
                    (a = n + e.height() + t),
                    l.addClass("menu-popout").appendTo(".main-menu-content").css({ top: a, position: "fixed", "max-height": o });
                new PerfectScrollbar(".main-menu-content > ul.menu-content", { wheelPropagation: !1 });
            },
            collapse: function (e, n) {
                e.children("ul")
                    .show()
                    .slideUp(r.app.nav.config.speed, function () {

!(function (o, r, p) {
    ...
    if (
        (p(o).on("scroll", function () {
            20 < p(o).scrollTop() ? p("body").addClass("page-scrolled navbar-scrolled") : p("body").removeClass("page-scrolled navbar-scrolled");
        }),
        p(o).on("load", function () {
            ...
            if ((t.css("height", s), u.hasClass("boxed-layout") && u.hasClass("vertical-overlay-menu"))) {
                ...
                u.hasClass("menu-flipped") ? p(".main-menu").css("right", i + "px") : p(".main-menu").css("left", i + "px");
            }
                ...
                p(".char-textarea").on("keyup", function (e) {
                    !(function (e, a) {
                        ...
                        p(".char-count").html(e.value.length),
                            e.value.length > n
                                ? (p(".counter-value").css("background-color", d), p(".char-textarea").css("color", d), p(".char-textarea").addClass("max-limit"))
        ...
        if (0 < p(e).length)
            new Hammer(e).on("panright", function (e) {
                if (u.hasClass("vertical-overlay-menu")) return p.app.menu.open(), !1;
            });
        setTimeout(function () {
            var e,
            ...
            0 < p(a).length &&
                ...
                e.on("panleft", function (e) {
                    if (u.hasClass("vertical-overlay-menu")) return p.app.menu.hide(), !1;
                }));
        }, 300);
        ...
        (p(r).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
            return (
                ...
                0 < p("#collapsed-sidebar").length &&
                    setTimeout(function () {
                        u.hasClass("menu-expanded") || u.hasClass("menu-open") ? p("#collapsed-sidebar").prop("checked", !1) : p("#collapsed-sidebar").prop("checked", !0);
                    }, 1e3),
    ...
    p(".bookmark-wrapper .bookmark-star").on("click", function (e) {
        ...
        p(".nav-link-search").on("click", function () {
            ...
            e.val(""), e.addClass("open"), p(".search-input input").focus(), p(".search-input .search-list li").remove(), p(".search-input .search-list").addClass("show"), p(".bookmark-wrapper .bookmark-input").removeClass("show");
        }),
                    ...
                    p.getJSON("../../../app-assets/data/" + h + ".json", function (e) {
                        for (var a = 0; a < e.listItems.length; a++) {
                            if (!0 === i) {
                                ...
                                u = '<span class="float-right bookmark-icon bx bx-star' + o + '"></span>';
                            }
    ...
    "function" == typeof jQuery.validator &&
        jQuery.validator.setDefaults({
            ...
            errorPlacement: function (e, a) {
                a.parent().hasClass("input-group") || a.hasClass("select2") || "checkbox" === a.attr("type") ? e.insertAfter(a.parent()) : a.hasClass("custom-control-input") ? e.insertAfter(a.parent().siblings(":last")) : e.insertAfter(a),
                    a.parent().hasClass("input-group") && a.parent().addClass("is-invalid");
            },
            highlight: function (e, a, n) {
                $(e).addClass("error"), $(e).parent().hasClass("input-group") && $(e).parent().addClass("is-invalid");
            },
            unhighlight: function (e, a, n) {
                $(e).removeClass("error"), $(e).parent().hasClass("input-group") && $(e).parent().removeClass("is-invalid");
            },
        });

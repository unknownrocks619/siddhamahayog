        ...
        <form ref="meeting_form" @submit.prevent="submitForm" method="post">
            <div class="card">
                    ...
                    <div class="row clearfix mt-3">
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="fields.program_name" class="form-control" name="program_name" id="program_name" require value="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <select v-model="fields.program_type" name="program_type" id="program_type" class='form-control' required>
                    ...
                    <div v-if="fields.program_type == 'paid'" class="row clearfix mt-3">
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="fields.monthly_fee" class="form-control" name="monthly_fee" id="monthly_fee" require value="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="fields.admission_fee" class="form-control" name="admission_fee" id="admission_fee" require value="" />
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix mt-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input type="date" v-model="fields.program_duration_start" class="form-control" name="program_duration_start" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input type="date" v-model="fields.program_duration_start" class="form-control" name="program_duration_end"  />
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix mt-3">
                        <div class="col-lg-12 col-md-12 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" v-model="fields.description" name="description" id="description"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix mt-3">
                        <div class="col-lg-6 col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input v-model="fields.promote"  type="radio" name="promote" id="promote_yes" value="yes">
                                            <label for="promote_yes" class='text-success'>
                                                Yes, Promote in Website
                                            </label>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="radio" v-model="fields.promote" checked name="promote" id="promote_no" value="no">
                        ...
                        <div v-if="fields.program_type == 'paid'" class="col-lg-6  col-md-6 col-sm-12 m-b-20">
                            <div class="form-group">
                                ...
                                <input type="number" required class="form-control" v-model="fields.overdue_allowed" name="overdue_allowed" id="overdue_allowed" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="footer clearfix mt-3">
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class='btn btn-primary btn-block'>Create New Program</button>
                        </div>
                    </div>
                </div>
            </div>

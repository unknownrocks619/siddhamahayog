...
class TextVideoWidgetController extends Controller
{
    //

    public function create() {
        return view("widget.items.text_video.create");
    }
    ...
    public function store(Request $request) {
        ...
        foreach ($request->text_title as $key => $value) {
            ...
            $innerArray["id"] = "widget_text_video_".$id;

...
class BannerVideoWidgetController extends Controller
{
    //

    public function create() {
        return view("widget.items.banner_video.create");
    }
    ...
    public function store(Request $request) {
        ...
        $widget->widget_type = "banner_video";
        $widgets = [];
        $id =  rand(150,1000);
        foreach ($request->text_title as $key => $value) {
            ...
            $innerArray["id"] = "widget_banner_video_".$id;

...
class AdminProgramController extends Controller
{
    ...
    public function store_batch_program(Request $request, Program $program) {
        ...
        if ($exists ) {
            $request->session()->flash('error',"Program is already associated with Batch");
            return back();
        }

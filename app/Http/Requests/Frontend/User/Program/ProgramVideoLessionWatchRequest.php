...
class ProgramVideoLessionWatchRequest extends FormRequest
{
    /**
    ...
    public function authorize()
    {
        ...
        if (!ProgramStudent::where('program_id', $this->program->id)
                    ->where('student_id', auth()->id())->exists()) return false;
